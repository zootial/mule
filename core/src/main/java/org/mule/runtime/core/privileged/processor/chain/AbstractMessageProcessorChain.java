...
abstract class AbstractMessageProcessorChain extends AbstractExecutableComponent implements MessageProcessorChain {
  ...
  private BiConsumer<Throwable, Object> getContinueStrategyErrorHandler(Processor processor,
                                                                        BiConsumer<BaseEventContext, ? super Exception> errorBubbler) {
    // final String representation = ((Component) processor).getLocation() != null
    // ? ((Component) processor).getLocation().getLocation()
    // : processor.toString();
    //
    // System.out.println(" >> EF for " + representation + " is ++++ " + errorHandler.toString());
    ...
    return (throwable, object) -> {
      // System.out.println(" >> Handling error at " + representation + " ...");
      // System.out.println(" >> Error handler: " + messagingExceptionHandler);
      // LOGGER.debug("Handling error at " + representation + " ...");
  ...
  protected FlowExceptionHandler getMessagingExceptionHandler() {
